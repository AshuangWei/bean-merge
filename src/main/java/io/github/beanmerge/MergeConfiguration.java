...
import io.github.beanmerge.notifier.function.GlobalUpdateNotifier;
import io.github.beanmerge.notifier.function.OrdinaryFieldUpdateNotifier;
import io.github.beanmerge.notifier.function.OrdinaryGlobalUpdateNotifier;
import io.github.beanmerge.notifier.function.SingleFieldUpdateNotifier;
...
public class MergeConfiguration<Source, Target> {
  ...
  public MergeConfiguration<Source, Target> notifyUpdateAny(List<String> paths, FieldUpdateNotifier<Source, Target> notifier) {
    this.notifiers.add(new UpdatedNotifier(paths.stream().collect(Collectors.toSet()), notifier, UpdatedNotifier.MatchMode.ANY));
    return this;
  }
